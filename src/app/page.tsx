...
import NewPriceSection from "@/components/NewPriceSection";
	...
	return (
		<main className="flex-auto min-w-0  flex flex-col px-2 md:px-0">
			<div className="max-w-4xl m-auto">
				<h1 className="font-medium text-3xl md:text-4xl lg:text-5xl mb-8 tracking-tighter">Massage relaxant - Halle</h1>
