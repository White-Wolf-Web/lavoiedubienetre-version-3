export const MetadataMassageSurChaise = [
	{
	  ...
	  "name": "Séance de massage sur chaise à Courcelles - Trazegnies",
	  "description": "Séance de massage sur chaise à Courcelles - Trazegnies - au sein de votre entreprise. Retrouvez ainsi harmonie, bien-être et sérénité dans un cadre apaisant.",
	  "address": {
		"@type": "PostalAddress",
