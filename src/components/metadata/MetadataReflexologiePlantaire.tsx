export const MetadataReflexologiePlantaire = [
	{
	  ...
	  "name": "Séance de réflexologie plantaire à Courcelles - Trazegnies",
	  "description": "Séance de réflexologie plantaire à Courcelles - Trazegnies. Découvrez nos soins personnalisés et retrouvez harmonie, bien-être et sérénité dans un cadre apaisant.",
	  "address": {
		"@type": "PostalAddress",
