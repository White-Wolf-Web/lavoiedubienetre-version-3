export const MetadataShiatsu = [
	{
	  ...
	  "name": "Séance de Shiatsu à Courcelles - Trazegnies",
	  "description": "Séance de Shiatsu à Courcelles - Trazegnies. Découvrez nos soins personnalisés et retrouvez harmonie, bien-être et sérénité dans un cadre apaisant.",
	  "address": {
		"@type": "PostalAddress",
