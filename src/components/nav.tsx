...
const navItems: Record<string, NavProps> = {
  '/': {
    name: (
      <svg xmlns="https://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-home iconHome">
